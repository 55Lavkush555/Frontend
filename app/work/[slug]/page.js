...
export default async function ProjectDetailPage({ params }) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-20 fade-in">
      ...
      <h1 className="text-4xl font-bold text-black mb-4 leading-tight">{project.name}</h1>
      ...
      <div className="flex gap-3 mb-10">
        {project.githubUrl && (
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-xl text-sm text-black hover:border-gray-400 transition-colors"
          >
        ...
        {project.liveUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 bg-black text-white rounded-xl text-sm hover:bg-gray-800 transition-colors"
          >
